Fetch the data from the [FIGMA_LINK], then based on the codebase and existing components, write the code for the lib/ui/component/[component_name].dart component.

## Steps:

1. Use get_code to fetch all data of the component in the [FIGMA_LINK]
...
4. Based on the data from the get_code command above, complete the {PascalCaseComponentName} component class. Follow the instructions:
    ...
    - Make the component flexible with parameters for different use cases
    - Add proper documentation comments for the component

5. Write golden tests and generate snapshots based on the instructions in .prompt_templates/golden_test/generate_golden_tests_prompt.md file with PAGE_FILE_PATH: lib/ui/component/[component_name].dart
...
- Component should be reusable and flexible
- Export the component through lib/index.dart
